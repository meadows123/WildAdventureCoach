...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:4242/send-contact', {
        method: 'POST',
        headers: {
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-6">
                {/* Email */}
                <div className="flex items-start space-x-4 p-4 bg-[#6B8E23]/10 rounded-xl border border-[#6B8E23]/30">
                  <Mail className="w-6 h-6 text-[#C65D2B] mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-[#F7F5EB] font-semibold mb-1">Email</h3>
                    <a 
                      href="mailto:wildadventurecoach2233@gmail.com"
                      className="text-[#DCCCA3] hover:text-[#C65D2B] transition-colors"
                    >
                      wildadventurecoach2233@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-4 bg-[#6B8E23]/10 rounded-xl border border-[#6B8E23]/30">
                  ...
                  <div>
                    ...
                    <p className="text-[#DCCCA3]">Rocky Mountains, Colorado</p>
                  </div>
                </div>
              </div>
