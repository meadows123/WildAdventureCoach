...
const BookingSuccessPage = () => {
  ...
  useEffect(() => {
    const fetchSessionData = async () => {
      ...
      try {
        const response = await fetch(`http://localhost:4242/checkout-session/${sessionId}`);
            ...
            <div className="space-y-6">
              <div className="bg-[#2E4A34]/50 rounded-xl p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <span className="text-[#DCCCA3] text-sm">Participants</span>
                    <p className="text-[#F7F5EB] text-lg">{metadata?.participants} {parseInt(metadata?.participants) === 1 ? 'person' : 'people'}</p>
                  </div>
                  <div>
                  ...
                  {metadata?.phone && (
                    <div>
                      ...
                      <p className="text-[#F7F5EB] text-lg">{metadata.phone}</p>
                    </div>
                  )}
                  <div>
