                            ...
                            <div className="space-y-2">
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex flex-col items-end gap-1">
                                  <span className={`text-2xl font-bold ${option.soldOut ? 'text-gray-500' : 'text-[#C65D2B]'}`}>
                                    £{option.price}
                                  </span>
                                  {option.originalPrice && (
                                    <span className={`text-base line-through ${option.soldOut ? 'text-gray-600' : 'text-[#DCCCA3]'}`}>
                                      £{option.originalPrice}
                                    </span>
                                  )}
                                </div>
                              </div>
                              <p className={`text-sm ${option.soldOut ? 'text-gray-500' : 'text-[#DCCCA3]'}`}>
                                {option.description}
                              </p>
                              <p className={`text-xs font-semibold mt-2 ${option.soldOut ? 'text-gray-600' : 'text-[#6B8E23]'}`}>
